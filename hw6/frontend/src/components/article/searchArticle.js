		...
		return (
			<div className="row well-white">
			    ...
			    <div className="form-group input-group">
			      <input type="text" id="search_text" className="form-control" ref={ (node) => article = node } placeholder="Search.."/>
			      <span className="input-group-btn">
			        <button className="btn btn-default" id="search_btn" type="button" onClick={_search}>

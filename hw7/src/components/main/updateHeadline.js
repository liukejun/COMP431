		...
		return (
			<div>
				<Col className="col-xs-12 col-sm-12 col-md-12 col-lg-8">
					<input type="text" id="updateheadline_newheadline" className="inputText_fixedWidth" name="mystatus" ref={ (node) => newheadline = node }  placeholder="What's new today?"/>
				</Col>
				<Col className="col-xs-12 col-sm-12 col-md-12 col-lg-4">
					<button id="updateheadline_btn" className="btn-update-in-profile" onClick={_update}>Update</button>
				</Col>
			</div>
		)
	}

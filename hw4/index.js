...
document.getElementById("btn_rotate").addEventListener("click",transform);
document.getElementById("btn_left").addEventListener("click",goLeft);
document.getElementById("btn_down").addEventListener("click",goDown);
document.getElementById("btn_right").addEventListener("click",goRight);
//globale variants
...
function init(){
	...
	state = 0;//state - current game state. 0:new round haven't started 1:working 2:stop
	score = 0;
	currentLevelScore = 0;
	maxScoreInLevel = 80;
	level = 1;
	...
	document.getElementById('btn_rotate').disabled = true;
}
function enableBtn(){

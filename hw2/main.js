...
var t1 = setInterval("changeImg('1')", 1000 * Math.floor((Math.random() * 6 )));
var t2 = setInterval("changeImg('2')", 1000 * Math.floor((Math.random() * 6 )));
var t3 = setInterval("changeImg('3')", 1000 * Math.floor((Math.random() * 6 )));
...
function action(num){
	...
	if(num==1){
		if(document.getElementById("img1b").value=="STOP"){
			...
			setInterval("changeImg('1')", 1000 * Math.floor((Math.random() * 6 )));
	...
	if(num==2){
		if(document.getElementById("img2b").value=="STOP"){
			...
			setInterval("changeImg('2')", 1000 * Math.floor((Math.random() * 6 )));
	...
	if(num == 3){
		if(document.getElementById("img3b").value=="STOP"){
			...
			setInterval("changeImg('3')", 1000 * Math.floor((Math.random() * 6 )));
